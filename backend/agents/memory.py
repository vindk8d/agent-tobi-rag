...
# =============================================================================
# CONTEXT WINDOW MANAGEMENT - REMOVED
# =============================================================================
# 
# The ContextWindowManager class has been removed in favor of LangGraph best practices:
# - Use add_messages annotation for automatic message management
# - Use conversation summarization instead of message trimming
# - Preserve message object integrity to avoid tool calling issues
# 
# Token counting functionality is now handled by individual components:
# - embeddings.py has its own tiktoken-based token counting
# - LangGraph handles message management through add_messages annotation
# - Background tasks handle conversation summarization when limits are reached
#
