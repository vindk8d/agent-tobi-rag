#!/usr/bin/env python3
"""
Monitor conversation summarization activity in real-time.
Use this to verify the summarization system is working in production.
"""
...
async def check_system_health():
    ...
    try:
        ...
        # Check configuration
        config_ok = (
            settings.memory_summary_interval > 0 and
            settings.memory_max_messages > 0 and
            settings.memory_summary_interval <= settings.memory_max_messages
        )
